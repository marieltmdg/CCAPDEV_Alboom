            ...
            <Main>
                ...
                {(isFilterMenuOpen || isFadingOut) && (
                    ...
                    >
                        ...
                        <h1>Sort</h1>
                        <div className={styles.button} onClick={sortByHighestRating}>Highest to Lowest Booms</div>
                        <div className={styles.button} onClick={sortByLowestRating}>Lowest to Highest Booms</div>
                        <h1>Filter</h1>
                        <input
                            type="number"
                            id="filterByNumber"
