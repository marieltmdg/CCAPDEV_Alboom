            ...
            <Main>
                ...
                {(isFilterMenuOpen || isFadingOut) && (
                    ...
                    >
                        ...
                        <h1>Filter</h1>
                        <div className={styles.button} onClick={sortByHighestRating}>Highest to Lowest Rating</div>
                        <div className={styles.button} onClick={sortByLowestRating}>Lowest to Highest Rating</div>
                        <input
                            type="number"
                            id="filterByNumber"
                            className={styles.booms}
                            placeholder="Number of Booms"
                        ...
                        <div className={styles.button} onClick={resetFilter}> Reset Filter </div>
                    </div>
                )}
