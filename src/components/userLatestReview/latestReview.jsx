...
const latestReviewData = [
    ...
    },
    {
        ...
        albumTitle: "Channel Orange",
        artist: "Frank Ocean",
        reviewText: "Lyrically deep and emotionally raw, a true work of art.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx     xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
        topComment: "The storytelling on this album is unmatched. xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
        albumCover: channelOrange,
        boomRating: 4,
    },
    {
        ...
        albumTitle: "Channel Orange",
        artist: "Frank Ocean",
        reviewText: "The production is exquisite, and the emotions run high throughout.",
    ...
    },
    {
        ...
        albumTitle: "Channel Orange",
        artist: "Frank Ocean",
        reviewText: "Frank Ocean's voice is magnetic, and the album's mood is hauntingly beautiful.",
    ...
    },
    {
        ...
        albumTitle: "Channel Orange",
        artist: "Frank Ocean",
        reviewText: "A timeless album that works wonders on vinyl, especially with its atmospheric soundscapes.",
        topComment: "Definitely a must-have for any vinyl enthusiast!",
        albumCover: channelOrange,
        boomRating: 5,
    }
];
